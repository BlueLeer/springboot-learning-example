package com.lee.springbootleeintegration;
...
public class SpringbootLeeIntegrationApplication {

    public static void main(String[] args) {

        SpringApplication.run(SpringbootLeeIntegrationApplication.class, args);
    }
